    ...
    <main className="min-h-screen w-full flex flex-col bg-gradient-to-b from-[#1a0a2e] via-[#0f172a] to-[#050818] text-white">
      ...
      <div className="relative z-10 flex flex-col min-h-screen max-w-[420px] mx-auto w-full px-5 pt-6 pb-8">
        ...
        <div className="flex flex-col items-center flex-1 pt-4">
          ...
          {intentGoogle && (
            <p className="text-emerald-200/90 text-sm text-center max-w-[320px] mb-4 rounded-xl bg-emerald-500/15 border border-emerald-400/25 px-4 py-3">
              Tu as terminé le parcours et le paiement. Connecte-toi avec Google pour accéder à l&apos;app sur ton téléphone et tous tes appareils.
            </p>
          )}
            ...
            {intentGoogle ? (
              <>
                ...
                >
                  ...
                  Se connecter avec Google pour accéder à l&apos;app
                </button>
                <button
                  type="button"
                  onClick={handleApple}
                  disabled={loading}
                  className="w-full flex items-center justify-center gap-3 rounded-xl bg-white/10 border border-white/20 py-3.5 text-white font-semibold hover:bg-white/15 transition-colors disabled:opacity-60"
                >
