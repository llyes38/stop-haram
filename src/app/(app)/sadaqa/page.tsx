          ...
          <div className="grid gap-3">
            {SADAQA_CAUSES.map((c) => (
              <button
                ...
                className="rounded-xl bg-white/5 border border-white/10 px-4 py-4 text-left flex items-center gap-4 hover:bg-white/10 hover:border-amber-400/30 transition-all"
              >
