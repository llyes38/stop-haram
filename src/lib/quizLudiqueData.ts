  ...
  porno: [
    {
      id: "porno-1",
      sin: "porno",
      question: "Que dit l'Islam sur la fréquentation entre un garçon et une fille non-mahram ?",
      choices: [
        "C'est permis tant qu'il n'y a pas de rapport.",
        "Être seul avec une personne du sexe opposé (sans mahram) est interdit.",
        "C'est permis si les parents sont au courant.",
      ],
      correctIndex: 1,
      explanation: "Le Prophète (ﷺ) a dit : « Un homme ne doit pas être seul avec une femme, car le tiers est Shaytan. »",
    },
    {
      id: "porno-2",
      sin: "porno",
      question: "Quel est le seul cadre licite pour une relation homme-femme ?",
      choices: [
        "Une relation sérieuse avec intention de mariage.",
        "Le mariage (nikah) accompli selon les conditions islamiques.",
        "Une relation avec l'accord des deux familles.",
      ],
      correctIndex: 1,
      explanation: "Toute relation intime ou fréquentation amoureuse en dehors du mariage est haram. Le mariage halal est la seule voie licite.",
    },
    {
      id: "porno-3",
      sin: "porno",
      question: "Que faire si on est tenté par une relation illicite ?",
      choices: [
        "Attendre que ça passe sans rien faire.",
        "Quitter la situation, faire wudhu, éviter d'être seul avec la personne.",
        "Continuer à discuter pour « rester amis ».",
      ],
      correctIndex: 1,
      explanation: "Fuir la tentation est une force. Quitter la situation, faire les ablutions et prier aide à préserver sa chasteté.",
    },
  ],
  musique: [
    {
